...
export const TrainCarContainer = (props) => {
  return (
    ...
    >
      <path
        fill='currentColor'
        d='M1 6v11h1a2 2 0 1 0 4 0h12a2 2 0 1 0 4 0h1V6H1m20 9h-2V9h-2v6h-2V9h-2v6h-2V9H9v6H7V9H5v6H3V8h18v7Z'
      ></path>
    </svg>
  );
};
...
export const TrainCarCenterbeam = (props) => {
  return (
    ...
    >
      <path
        fill='currentColor'
        d='M23 6v11h-1c0 1.11-.89 2-2 2s-2-.89-2-2H6c0 1.11-.89 2-2 2s-2-.89-2-2H1V6h2v9h18V6h2Z'
      ></path>
    </svg>
  );
};
